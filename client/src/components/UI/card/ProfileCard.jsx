...
const ProfileCard = () => {
  ...
  return (
    <>
      <EditProfileModal showModal={showModal} onHideModal={hideModalHandler} />
        ...
        <div className="px-10 flex flex-col gap-4 pb-6">
          <div className="relative flex flex-row-reverse pt-4">
            ...
            <button
              ...
              className={`text-highlight font-bold py-1 px-4 border-[1px] border-highlight rounded-full focus:outline-none hover:bg-highlight hover:text-light-main transition-colors duration-75`}
            >
              Edit Profile
            </button>
          </div>
