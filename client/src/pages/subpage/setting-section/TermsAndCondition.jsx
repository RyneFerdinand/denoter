const TermsAndCondition = () => {
  return (
    <div className="py-6 flex flex-col gap-2">
      <p>Welcome to Denoter!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Denoter's Website, located at www.denoter.netlify.app.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Denoter if you do not agree to take
      ...
      <h2 className="text-lg pt-6 font-medium">Cookies</h2>

      <p>
        We employ the use of cookies. By accessing Denoter, you agreed to use
        cookies in agreement with the Denoter's Privacy Policy.{" "}
      </p>
      ...
      <h2 className="text-lg pt-6 font-medium">License</h2>

      <p>
        Unless otherwise stated, Denoter and/or its licensors own the
        intellectual property rights for all material on Denoter. All
        intellectual property rights are reserved. You may access this from
        Denoter for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul className="list-disc pl-4">
        <li>Republish material from Denoter</li>
        <li>Sell, rent or sub-license material from Denoter</li>
        <li>Reproduce, duplicate or copy material from Denoter</li>
        <li>Redistribute content from Denoter</li>
      </ul>
      ...
      <p>
        ...
        Denoter does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Denoter,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, Denoter shall not be liable for the
      ...
      <p>
        Denoter reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Denoter a non-exclusive license to use, reproduce, edit
        and authorize others to use, reproduce and edit any of your Comments in
        any and all forms, formats or media.
      </p>

      <h2 className="text-lg pt-6 font-medium">Hyperlinking to our Content</h2>
      ...
      <p>
        ...
        the hyperlink compensates the absence of Denoter; and (d) the link is in
      ...
      <p>
        ...
        e-mail to Denoter. Please include your name, your organization name,
      ...
      <p>
        No use of Denoter's logo or other artwork will be allowed for linking
        absent a trademark license agreement.
      </p>

      <h2 className="text-lg pt-6 font-medium">iFrames</h2>
      ...
      <h2 className="text-lg pt-6 font-medium">Content Liability</h2>
      ...
      <h2 className="text-lg pt-6 font-medium">Your Privacy</h2>

      <p>Please read Privacy Policy</p>

      <h2 className="text-lg pt-6 font-medium">Reservation of Rights</h2>
      ...
      <h2 className="text-lg pt-6 font-medium">
      ...
      <h2 className="text-lg pt-6 font-medium">Disclaimer</h2>
      ...
      <h2 className="pt-6 font-medium">
        Please Note that the Terms and Condition is auto generated and that this
        is a personal project with no commercial purposes
      </h2>
    </div>
  );
};
